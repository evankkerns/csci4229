                        ...
                        double th)
{
  ...
  glVertex3f(15,1.4,9.3);
  glVertex3f(15,1.4,9.3);
  glVertex3f(15,1.4,12);
  // Right Field Lower Seats - Corner
  glVertex3f(14,.6,12);
  glVertex3f(15,1.4,12);
  glVertex3f(15,1.4,14);
  glVertex3f(13,.6,14);
                        ...
                        double th)
{
  ...
  // Front
  glColor3ub(74,119,75);
  glVertex3f(-3.75, 0, 17);
  glVertex3f(-3.75, .6, 17);
  glVertex3f(7, .6, 17);
  glVertex3f(7, 0, 17);
  // Seats
  glColor3ub(74,119,75);
  glVertex3f(-3.75, 1.4, 19);
  glVertex3f(-3.75, .6, 17);
  glVertex3f(7, .6, 17);
  glVertex3f(7, 1.4, 19);
  // Back
  ...
  glVertex3f(-3.75, 0, 17);
  glVertex3f(-3.75, .6, 17);
  glVertex3f(-7, .6, 13.75);
  glVertex3f(-7, 0, 13.75);
  // Seats
  glColor3ub(74,119,75);
  glVertex3f(-3.75, 1.4, 19);
  glVertex3f(-3.75, .6, 17);
  glVertex3f(-7, .6, 13.75);
  glVertex3f(-9, 1.4, 13.75);
  // Back
  glColor3ub(74,119,75);
  glVertex3f(-3.75, 1.4, 19);
  glVertex3f(-3.75, 0, 19);
  glVertex3f(-9, 0, 13.75);
  glVertex3f(-9, 1.4, 13.75);
  ...
  // Corner Wall
  glColor3ub(74,119,75);
  glVertex3f(-4.5, 1.4, 1);
  glVertex3f(-4.5, 0, 1);
  glVertex3f(-4.5, 0, 6);
  glVertex3f(-4.5, .6, 6);
  // Corner Seats
  glColor3ub(74,119,75);
  glVertex3f(-7.5, 1.4, 1);
  glVertex3f(-4.5, 1.4, 1);
  glVertex3f(-4.5, .6, 6);
  glVertex3f(-7.5, 1.4, 6);
  // Corner Back
                        ...
                        double th)
{
  ...
  // TV Booths Seats
  //glColor3ub(74,119,75);
  glColor3ub(174,119,175);
  glVertex3f(-3.75, 2, 17);
  glVertex3f(-4.75, 3, 18);
  glVertex3f(-8, 3, 14.75);
  glVertex3f(-7, 2, 13.75);
  // TV Booths
  // Front
  //glColor3ub(74,119,75);
  glColor3ub(74,119,175);
  glVertex3f(-4.75, 5, 18);
  glVertex3f(-4.75, 3, 18);
  glVertex3f(-8, 3, 14.75);
  glVertex3f(-8, 5, 14.75);
  // 3rd Base Side
  glVertex3f(-9, 5, 15.75);
  glVertex3f(-9, 3, 15.75);
  glVertex3f(-8, 3, 14.75);
  glVertex3f(-8, 5, 14.75);
  // 1st Base Side
  glVertex3f(-4.75, 5, 18);
  glVertex3f(-4.75, 3, 18);
  glVertex3f(-5.75, 3, 19);
  glVertex3f(-5.75, 5, 19);
  // Back
  glVertex3f(-5.75, 5, 19);
  glVertex3f(-5.75, 3, 19);
  glVertex3f(-9, 3, 15.75);
  ...
  glVertex3f(14, 3, 18);
  glVertex3f(13, 2, 17);
  glVertex3f(15, 2, 14.5);
  glVertex3f(16, 3, 14.5);
  // Back
  glVertex3f(14, 3, 18);
  glVertex3f(14, 2, 18);
  glVertex3f(16, 2, 14.5);
  glVertex3f(16, 3, 14.5);
